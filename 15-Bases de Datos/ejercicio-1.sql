...
select title, rating from movies where title='Toy Story'; -- exactamente
select title, rating from movies where title like '%Toy Story%'; -- que tenga la palabra entremedio
